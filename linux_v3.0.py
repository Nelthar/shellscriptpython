...
#return_code = subprocess.call('wget -0 - https://github.com/meetfranz/franz-app/releases/download/3.1.1/Franz-linux-x64-3.1.1.tgz | tar xzf -', shell=True)	
...
return_code = subprocess.call('sudo tar -vzxf Franz-linux-x64-3.1.1.tgz -C /opt/franz/', shell=True)	
